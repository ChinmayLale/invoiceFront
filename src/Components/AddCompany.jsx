...
function AddCompany() {
    ...
    return (
        <div className='relative flex-[4]  h-[90vh] w-full flex flex-col'>
            ...
            <div className="getonfo mt-5  w-[60%]">
                <form class="max-w-[80%] mx-auto">
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="OwnerName" id="OwnerName" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required 
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={(e)=>{handleDefalut(e)}}>Submit</button>
                </form>
